 ...
 *
 * Represents a ForbiddenException error, indicating that a user does not have permission to access a resource.
 */
class ForbiddenException extends LocalizedException
{
    /**
     * The type of the error (ForbiddenError).
     *
     * @var string
     */
    protected string $type = 'ForbiddenError';
    ...
    /**
     * Static factory method to create a new instance of ForbiddenException.
     *
     * @param Phrase $message The error message encapsulated in a Phrase object.
     * @param Throwable|null $cause The original exception that caused this exception (optional).
     * @param int|null $statusCode The status code for the error (optional).
     ...
     * @param string[]|null $context Additional context or data related to the exception (optional).
     *
     * @return self A new instance of the ForbiddenException.
     */
