 ...
 *
 * Represents an InternalServerException error, indicating HTTP 500 Internal Server Error.
 */
class InternalServerException extends LocalizedException
{
    /**
     * The type of the error (InternalServerError).
     *
     * @var string
     */
    protected string $type = 'InternalServerError';
    ...
    /**
     * Static factory method to create a new instance of InternalServerException.
     *
     * @param Phrase $message The error message encapsulated in a Phrase object.
     * @param Throwable|null $cause The original exception that caused this exception (optional).
     * @param int|null $statusCode The status code for the error (optional).
     ...
     * @param string[]|null $context Additional context or data related to the exception (optional).
     *
     * @return self A new instance of the InternalServerException.
     */
